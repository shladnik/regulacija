...
void furnace_loop()
{
  temp_t t_furnace_t = ds18b20_get_temp(DS18B20_FURNACE_T, RESOLUTION_9, 8);
#if 1
  //temp_t t_furnace_b = ds18b20_get_temp(DS18B20_FURNACE_B, RESOLUTION_9, 8);
  ...
  temp_t curr  = ds18b20_get_temp(DS18B20_FURNACE_B, RESOLUTION_12, 8);
  _delay_ms(1000);
  temp_t curr2 = ds18b20_get_temp(DS18B20_FURNACE_B, RESOLUTION_12, 8);
